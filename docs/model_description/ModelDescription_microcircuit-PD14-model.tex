...
\begin{tabular}{
  ...
  \hline 
<<<<<<< HEAD:docs/model_description/ModelDescription_microcircuit-PD14-model.tex
...
=======
  ...
  \hline 
   ...
   \\
>>>>>>> 99586e36 (Corrected cortico-cortical inputs in model description):docs/ModelDescription_microcircuit-PD14-model.tex
  \hline 
\end{tabular}
%%%%%%%%%%%%%%%%%%%
...
\begin{enumerate}
  %%% 
\item \label{remark:initial_voltages} The initial voltages...
\item \label{remark:DC_stim} DC stimulation...
\item \label{remark:initial_conditions} The initial conditions...
\end{enumerate}
